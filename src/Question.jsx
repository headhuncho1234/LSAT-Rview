      ...
      {!revealed ? (
        ...
        <div style={{ animation: 'fadeUp 0.25s ease' }}>
          ...
          <div className={`result-banner ${isCorrect ? 'correct-banner' : 'wrong-banner'}`}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div>
                <div style={{ fontWeight: 700, fontSize: 15, color: isCorrect ? 'var(--green)' : 'var(--red)' }}>
                  {isCorrect ? 'Correct!' : `Wrong — Answer: ${currentQ.correctAnswer}`}
                </div>
                {streak >= 3 && isCorrect && (
            ...
            <div style={{ textAlign: 'right' }}>
              ...
              {timeTaken < 60 && isCorrect && (
                <div style={{ fontSize: 11, color: 'var(--green)', marginTop: 1 }}>⚡ speed bonus</div>
              )}
            </div>
          </div>
          ...
          <div style={{ display: 'flex', gap: 10 }}>
            ...
            >
              {loading ? (
                <><span className="spinner"><Loader size={15} /></span> Loading…</>
              ) : (
